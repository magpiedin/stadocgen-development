...
dwc_localtsv = str(root) + '/mids/app/data/source/mids-repo/' + dwc_filestem + '.tsv'
dwc_localcsv = str(root) + '/mids/app/data/source/mids-repo/' + dwc_filestem + '.csv'
dwc_sssomfile = str(root) + '/mids/app/data/output/mids-dwc-sssom.csv'
dwc_uniquecsv = str(root) + '/mids/app/data/source/mids-repo/dwc_unique_class_property_pairs.csv'
...
abcd_localtsv = str(root) + '/mids/app/data/source/mids-repo/' + abcd_filestem + '.tsv'
abcd_localcsv = str(root) + '/mids/app/data/source/mids-repo/' + abcd_filestem + '.csv'
abcd_sssomfile = str(root) + '/mids/app/data/output/mids-abcd-sssom.csv'
abcd_uniquecsv = str(root) + '/mids/app/data/source/mids-repo/abcd_unique_class_property_pairs.csv'
